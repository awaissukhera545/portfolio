...
export const portfolioItems = [
  {
    ...
    description: "Multi-tenant productivity platform with task automation, real-time collaboration and analytics.",
    tags: ["React", "Next.js", "Node.js", "PostgreSQL"],
    categories: ["Productivity", "SaaS"],
    year: 2024,
    role: "Lead Engineer",
    link: "https://github.com/awaissukhera545/taskflow",
  },
  {
    id: 2,
    animationOrder: 2,
    ...
    width: 1939,
    height: 1572,
    title: "PulseFit — Workout & Nutrition App",
    description: "Cross-platform Flutter app that tracks workouts, nutrition and personalized plans with Firebase backend.",
    tags: ["Flutter", "Firebase", "Dart"],
    categories: ["Mobile Apps", "Health Tech"],
    year: 2023,
    role: "Mobile Lead",
    link: "https://github.com/awaissukhera545/pulsefit",
  },
  {
    id: 3,
    animationOrder: 3,
    ...
    description: "Interactive analytics dashboard with custom visualizations, role-based access and CSV export.",
    tags: ["React", "TypeScript", "D3", "Node.js"],
    categories: ["Analytics", "Data Viz"],
    year: 2022,
    role: "Full-stack Engineer",
    link: "https://github.com/awaissukhera545/insightdash",
  },
  {
    id: 4,
    animationOrder: 4,
    ...
    description: "Headless ecommerce using Next.js and Stripe, optimized for conversion and fast checkout flows.",
    tags: ["Next.js", "Stripe", "MongoDB"],
    categories: ["E-commerce", "Payments"],
    year: 2022,
    role: "Frontend Engineer",
    link: "https://github.com/awaissukhera545/shopsmart",
  },
  {
    id: 5,
    animationOrder: 5,
    ...
    width: 1200,
    height: 800,
    title: "BrandSite — Marketing Website",
    description: "Fast marketing site with CMS-driven content and SEO optimizations for conversion.",
    tags: ["Next.js", "Sanity", "SEO"],
    categories: ["Marketing", "Brand"],
    year: 2021,
    role: "Frontend Developer",
    link: "https://github.com/awaissukhera545/brandsite",
  },
  {
    id: 6,
    animationOrder: 6,
    ...
    width: 1200,
    height: 800,
    title: "ConnectNow — Real-time Chat App",
    description: "Real-time messaging with presence, typing indicators and file attachments using Socket.io.",
    tags: ["React", "Socket.io", "Node.js"],
    categories: ["Realtime", "Communication"],
    year: 2020,
    role: "Full-stack Engineer",
    link: "https://github.com/awaissukhera545/connectnow",
  },
].map((elm) => {
  return {
    ...elm,
