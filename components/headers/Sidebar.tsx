          ...
          <div className="content-wrapper">
            ...
            <div className="short-contact-area">
              ...
              <div className="single-contact">
                ...
                <div className="information tmp-link-animation">
                  <span>Call Now</span>
                  <a href="tel:+923266699494" className="number">
                    +92 326 669 9494
                  </a>
                </div>
              </div>
            ...
            <div className="social-wrapper mt--20">
              ...
              <div className="social-link">
                <a href="https://github.com/awaissukhera545/" target="_blank" rel="noreferrer">
                  <i className="fa-brands fa-github" />
                </a>
                <a href="https://www.linkedin.com/in/awaissukhera545/" target="_blank" rel="noreferrer">
